        ...
        app.component('v-product-card', {
            ...
            methods: {
                ...
                addToCompare(productId) {
                    console.log('addToCompare called, isCustomer:', this.isCustomer, 'productId:', productId);
                    /**
                     * This will handle for customers.
                     */
                    if (this.isCustomer) {
                        console.log('Calling API for customer');
                     ...
                     */
                    console.log('Updating localStorage for guest');
